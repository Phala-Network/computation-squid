...
export class PhalaBasePoolNftCreatedEvent {
     ...
     */
    get isV1191(): boolean {
        return this._chain.getEventHash('PhalaBasePool.NftCreated') === 'cd946726d9260b1ce43ee0361b81cf6d0ca1fd4ab3fe3493b96cfb6fc97cc410'
    }

    /**
     * A Nft is created to contain pool shares
     */
    get asV1191(): {cid: number, nftId: number, owner: Uint8Array, shares: bigint} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
...
export class PhalaBasePoolWithdrawalQueuedEvent {
     ...
     *   withdraw queue in [`Pools`]
     */
    get asV1191(): {pid: bigint, user: Uint8Array, shares: bigint, nftId: number, asVault: (bigint | undefined)} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PhalaStakePoolv2ContributionEvent {
     ...
     *   ([`Withdrawal`](#variant.Withdrawal) event)
     */
    get asV1191(): {pid: bigint, user: Uint8Array, amount: bigint, shares: bigint, asVault: (bigint | undefined)} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PhalaStakePoolv2PoolCreatedEvent {
     ...
     * - a new entry in [`Pools`] with the pid
     */
    get asV1191(): {owner: Uint8Array, pid: bigint, cid: number, poolAccountId: Uint8Array} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class PhalaVaultOwnerSharesGainedEvent {
     ...
     * - last_share_price_checkpoint in [`Pools`]
     */
    get asV1191(): {pid: bigint, shares: bigint, checkoutPrice: bigint} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class RmrkCoreNftBurnedEvent {
    ...
    get asV1191(): {owner: Uint8Array, collectionId: number, nftId: number} {
        assert(this.isV1191)
        return this._chain.decodeEvent(this.event)
    }
}
