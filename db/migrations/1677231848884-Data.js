module.exports = class Data1677231848884 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE INDEX "IDX_de5f9d9f586feada9d0c362a12" ON "delegation_snapshot" ("delegation_id") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_de5f9d9f586feada9d0c362a12"`)
