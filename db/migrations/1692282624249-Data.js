module.exports = class Data1692282624249 {
    name = 'Data1692282624249'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "global_state_snapshot" ("id" character varying NOT NULL, "updated_time" TIMESTAMP WITH TIME ZONE NOT NULL, "total_value" numeric NOT NULL, "average_block_time" integer NOT NULL, "average_apr" numeric NOT NULL, "cumulative_rewards" numeric NOT NULL, "budget_per_block" numeric NOT NULL, "worker_count" integer NOT NULL, "idle_worker_count" integer NOT NULL, "budget_per_share" numeric NOT NULL, "delegator_count" integer NOT NULL, CONSTRAINT "PK_f168dfb48948e182df276f30021" PRIMARY KEY ("id"))`)
