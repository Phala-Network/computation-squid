module.exports = class Data1708273517919 {
    name = 'Data1708273517919'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "delegation_snapshot" ("id" character varying NOT NULL, "updated_time" TIMESTAMP WITH TIME ZONE NOT NULL, "cost" numeric NOT NULL, "value" numeric NOT NULL, "delegation_id" character varying, CONSTRAINT "PK_335066227038f09d171baca0bb9" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_22443055645351a609de9484f5" ON "delegation_snapshot" ("delegation_id", "updated_time") `)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_3801c73b4f257fa3d70cb94772" ON "account_snapshot" ("account_id", "updated_time") `)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_7c738c2364b8548a117089f684" ON "base_pool_snapshot" ("base_pool_id", "updated_time") `)
        ...
        await db.query(`CREATE TABLE "worker_snapshot" ("id" character varying NOT NULL, "updated_time" TIMESTAMP WITH TIME ZONE NOT NULL, "stake_pool_id" text, "session_id" text, "confidence_level" integer NOT NULL, "initial_score" integer, "stake" numeric, "state" character varying(18), "v" numeric, "ve" numeric, "p_init" integer, "p_instant" integer, "total_reward" numeric, "worker_id" character varying, CONSTRAINT "PK_5140a438c3891406b7420770cb9" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_41e43066b56549dd372b3e6860" ON "worker_snapshot" ("worker_id", "updated_time") `)
        ...
        await db.query(`ALTER TABLE "delegation_snapshot" ADD CONSTRAINT "FK_de5f9d9f586feada9d0c362a12c" FOREIGN KEY ("delegation_id") REFERENCES "delegation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_22443055645351a609de9484f5"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_3801c73b4f257fa3d70cb94772"`)
        await db.query(`DROP TABLE "base_pool_snapshot"`)
        await db.query(`DROP INDEX "public"."IDX_7c738c2364b8548a117089f684"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_41e43066b56549dd372b3e6860"`)
        ...
        await db.query(`ALTER TABLE "delegation_snapshot" DROP CONSTRAINT "FK_de5f9d9f586feada9d0c362a12c"`)
