module.exports = class Data1669760730463 {
  name = 'Data1669760730463'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "delegation" ("id" character varying NOT NULL, "value" numeric NOT NULL, "shares" numeric NOT NULL, "withdrawal_value" numeric NOT NULL, "withdrawal_shares" numeric NOT NULL, "withdrawal_start_time" TIMESTAMP WITH TIME ZONE, "account_id" character varying, "base_pool_id" character varying, "delegation_nft_id" character varying, "withdrawal_nft_id" character varying, CONSTRAINT "PK_a2cb6c9b942d68b109131beab44" PRIMARY KEY ("id"))`)
